...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 691, 384))
        ...
        self.InputEndArquivo = QtWidgets.QLineEdit(self.centralwidget)
        self.InputEndArquivo.setObjectName("InputEndArquivo")
        self.gridLayout.addWidget(self.InputEndArquivo, 1, 0, 1, 4)
